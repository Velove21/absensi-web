...
## Goal
Replace Nixpacks deployment with a custom, multi-stage Dockerfile using Node 22 Alpine for compiling assets and `serversideup/php:8.4-fpm-nginx` for production serving, aligning with PHP 8.4 dependencies.
